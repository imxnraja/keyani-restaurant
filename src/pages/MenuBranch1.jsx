    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="relative pt-32 pb-16 px-6 text-center overflow-hidden">
        ...
        <span className="inline-flex items-center gap-2 text-orange text-xs tracking-[0.35em] uppercase font-bold mb-3 block">
          <span className="w-6 h-px bg-orange" /> Branch 1 — Aslam Market <span className="w-6 h-px bg-orange" />
        </span>
        ...
        <div className="flex items-center justify-center flex-wrap gap-5 mt-5">
          <span className="flex items-center gap-1.5 text-white/35 text-xs">
            ...
            Aslam Market, Wah Cantt
          </span>
          <span className="flex items-center gap-1.5 text-white/35 text-xs">
            <HiPhone size={12} className="text-orange" />
            0302 5202020
          </span>
          <span className="text-white/35 text-xs">🕐 12:00 PM – 1:00 AM</span>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-20">
        ...
        <div className="mt-8 relative gradient-orange rounded-2xl p-8 text-center overflow-hidden">
          ...
          <p className="text-white/70 text-sm mt-2">Order from Branch 1 — delivered straight to your door.</p>
        ...
        {/* Branch 2 teaser */}
        <div className="mt-6 rounded-2xl border border-white/6 bg-white/2 p-6 flex flex-col sm:flex-row items-center gap-5">
          <div className="text-3xl shrink-0">🎉</div>
          <div className="flex-1 text-center sm:text-left">
            <p className="text-sm font-bold text-white/60">Looking for Events, Tawa Special, or Desserts?</p>
            <p className="text-xs text-white/30 mt-1">Branch 2 (GT Road) offers a fuller menu with Tawa dishes, Desserts, and a dedicated Events &amp; Reservation facility with Room and Terrace.</p>
          </div>
          <Link to="/menu/branch2" className="shrink-0 flex items-center gap-2 border border-orange/30 text-orange text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-orange/10 transition-all">
            Branch 2 Menu <HiArrowRight size={14} />
          </Link>
        </div>
      </div>
    </div>
